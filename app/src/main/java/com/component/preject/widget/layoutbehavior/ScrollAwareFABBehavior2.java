package com.component.preject.widget.layoutbehavior;
 ...
 * @Package: com.component.preject.widget
 * @ClassName: ScrollAwareFABBehavior2
 * @Author: xzg
 * @CreateDate: 2019-08-27 14:40
 * @UpdateUser: 更新者
 * @UpdateDate: 2019-08-27 14:40
 * @UpdateRemark: 更新说明
 * @Version: 1.0
...
public class ScrollAwareFABBehavior2 extends CoordinatorLayout.Behavior<FloatingActionButton>  {
    ...
    private static final String TAG = ScrollAwareFABBehavior2.class.getSimpleName();
